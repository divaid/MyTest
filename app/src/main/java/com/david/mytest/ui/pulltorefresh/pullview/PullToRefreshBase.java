...
import com.david.mytest.ui.pulltorefresh.internal.DetailLoadingLayout;
import com.david.mytest.ui.pulltorefresh.internal.FlipLoadingLayout;
import com.david.mytest.ui.pulltorefresh.internal.HippoLoadingLayout;
import com.david.mytest.ui.pulltorefresh.internal.HomeFreshLoadingLayout;
import com.david.mytest.ui.pulltorefresh.internal.LoadingLayout;
import com.david.mytest.ui.pulltorefresh.internal.RotateLoadingLayout;
import com.david.mytest.ui.pulltorefresh.internal.SimpleLoadingLayout;
import com.david.mytest.ui.pulltorefresh.internal.Utils;
import com.david.mytest.ui.pulltorefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    protected PullDownScaleListener pullDownScaleListener;
    private long actionDownTime;

    /**
     * 用于生鲜首页获得下拉刷新的距离
     */
    public interface PullDownScaleListener {
        void onScaleChanged(float scale);

        void onPullDownRelease(boolean isPullDownRelease);
    }

    public void setPullDownScaleListener(PullDownScaleListener pullDownListener) {
        this.pullDownScaleListener = pullDownListener;
    }

    public void releasePullDownScaleListener() {
        this.pullDownScaleListener = null;
    }
    ...
    protected void onPullToRefresh() {
        switch (mCurrentMode) {
            ...
            case PULL_FROM_START:
                if (pullDownScaleListener != null) {
                    actionDownTime = System.currentTimeMillis();
                    pullDownScaleListener.onPullDownRelease(false);
                }
        ...
        if (newScrollValue != 0 && !isRefreshing()) {
            ...
            switch (mCurrentMode) {
                ...
                default:
                    ...
                    if (pullDownScaleListener != null) {
                        pullDownScaleListener.onScaleChanged(scale);
                    }
    ...
    public static enum AnimationStyle {
        ...
        LoadingLayout createLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs) {
            switch (this) {
                ...
                case NORMAL:
                    return new HippoLoadingLayout(context, mode, scrollDirection, attrs);
                case HOME_FRESH:
                    return new HomeFreshLoadingLayout(context, mode, scrollDirection, attrs);
                case DETAIL:
                    return new DetailLoadingLayout(context, mode, scrollDirection, attrs);
                case SIMPLE:
                    return new SimpleLoadingLayout(context, mode, scrollDirection, attrs);
            }
        }
    }
