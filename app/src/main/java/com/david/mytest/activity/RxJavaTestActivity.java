...
public class RxJavaTestActivity extends BaseActivity {
    ...
    private void request2() {
        ...
        Call<com.david.mytest.requestBean.ThemeDailyBean> themeDaily = requestApi.getThemeDaily(12);
        themeDaily.enqueue(new Callback<com.david.mytest.requestBean.ThemeDailyBean>() {
            @Override
            public void onResponse(Call<com.david.mytest.requestBean.ThemeDailyBean> call, Response<com.david.mytest.requestBean.ThemeDailyBean> response) {
                if (response.isSuccessful()) {
                    com.david.mytest.requestBean.ThemeDailyBean themeDailyBean = response.body();
                    Logger.d(themeDailyBean);
                }
            }

            @Override
            public void onFailure(Call<com.david.mytest.requestBean.ThemeDailyBean> call, Throwable t) {
    ...
    private void useRxJava_Retrofit() {
        ...
        requestApi.getThemes()
                ...
                .subscribe(new Consumer<com.david.mytest.requestBean.ThemesBean>() {
                    @Override
                    public void accept(com.david.mytest.requestBean.ThemesBean themesBean) throws Exception {
