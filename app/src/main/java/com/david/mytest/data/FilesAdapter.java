...
public class FilesAdapter extends BaseAdapter {
    ...
    private List<com.david.mytest.download.FileInfo> mFileInfos;
    private Messenger mMessenger;

    public FilesAdapter(Context mContext, List<com.david.mytest.download.FileInfo> mFileInfos) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final com.david.mytest.download.FileInfo mFileInfo = mFileInfos.get(position);
        ViewHolder holder;
        if (convertView == null) {
            ...
            holder.btStart.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(mContext, com.david.mytest.download.DownloadService.class);
                    intent.setAction(com.david.mytest.download.DownloadService.ACTION_START);
...
//                    }
            ...
            holder.btStop.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(mContext, com.david.mytest.download.DownloadService.class);
                    intent.setAction(com.david.mytest.download.DownloadService.ACTION_STOP);
                    intent.putExtra("fileInfo", mFileInfo);
                    mContext.startService(intent);
...
//                    }
    ...
    public void updateProgress(int id, int progress) {
        com.david.mytest.download.FileInfo fileInfo = mFileInfos.get(id);
