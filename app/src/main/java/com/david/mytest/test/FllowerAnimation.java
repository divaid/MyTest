...
//          bitmap.recycle();
    ...
    public void startAnimation() {
        ValueAnimator mAnimator1 = ValueAnimator.ofFloat(phase1, pathMeasure.getLength());
        mAnimator1.setDuration(time);
        mAnimator1.addUpdateListener(this);
        mAnimator1.start();
        mAnimator1.setInterpolator(new AccelerateInterpolator(1f));

        ValueAnimator mAnimator2 = ValueAnimator.ofFloat(phase2,pathMeasure.getLength());
        ...
        ValueAnimator mAnimator3 = ValueAnimator.ofFloat(phase3, pathMeasure.getLength());
    ...
    public void onAnimationUpdate(ValueAnimator arg0) {
        ...
        updateValue((Float) arg0.getAnimatedValue(), fllowers1);
        updateValue((Float) arg0.getAnimatedValue(), fllowers2);
        updateValue((Float) arg0.getAnimatedValue(), fllowers3);
        invalidate();
    }
